...
@click.option("--compressor-class", default=None, help="Same as in summarize_compression.")
@click.option("--filter-class", default=None, help="Same as in summarize_compression.")
@click.option("--serializer-class", default=None, help="Same as in summarize_compression.")
def compress_with_optimal(netcdf_file, where_to_write, field_to_compress, 
    ...
    as in summarize_compression to ensure consistency.
    ...
    Args:
        ...
        compressor_class (str | None, optional): Look summarize_compression.
        filter_class (str | None, optional): Look summarize_compression.
        serializer_class (str | None, optional): Look summarize_compression.
    """
    comm = MPI.COMM_WORLD
    rank = comm.Get_rank()
    size = comm.Get_size()
